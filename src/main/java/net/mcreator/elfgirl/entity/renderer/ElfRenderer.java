package net.mcreator.elfgirl.entity.renderer;
...
import net.mcreator.elfgirl.entity.ElfEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class ElfRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ElfEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelalex(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("elfgirl:textures/2021_07_16__-elf-girl-_-18410915.png");
					}
				};
			});
		}
