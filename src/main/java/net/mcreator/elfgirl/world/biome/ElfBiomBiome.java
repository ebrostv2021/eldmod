...
package net.mcreator.elfgirl.world.biome;
...
import net.mcreator.elfgirl.block.ElfLogBlock;
import net.mcreator.elfgirl.block.ElfLeafBlock;
...
public class ElfBiomBiome extends ElfgirlModElements.ModElement {
	public static Biome biome;
	public ElfBiomBiome(ElfgirlModElements instance) {
		super(instance, 4);
			...
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-26113).setWaterColor(-6710785).setWaterFogColor(-6710785)
						...
						.setMusic(new BackgroundMusicSelector(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("elfgirl:elf")), 12000,
								24000, true))
						.build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(ElfLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(ElfLeafBlock.block.getDefaultState()),
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(ElfEntity.entity, 20, 4, 4));
				...
				event.getRegistry().register(biome.setRegistryName("elfgirl:elf_biom"));
			}
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		BiomeManager.addBiome(BiomeManager.BiomeType.WARM,
				new BiomeManager.BiomeEntry(RegistryKey.getOrCreateKey(Registry.BIOME_KEY, WorldGenRegistries.BIOME.getKey(biome)), 14));
	}
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("elf_biom_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("elf_biom_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
