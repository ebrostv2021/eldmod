...
public class ElfSlapBlock extends ElfgirlModElements.ModElement {
	@ObjectHolder("elfgirl:elf_slap")
	public static final Block block = null;
	public ElfSlapBlock(ElfgirlModElements instance) {
		super(instance, 15);
	}
