...
public class ElfLogBlock extends ElfgirlModElements.ModElement {
	@ObjectHolder("elfgirl:elf_log")
	public static final Block block = null;
	public ElfLogBlock(ElfgirlModElements instance) {
		super(instance, 5);
	}
